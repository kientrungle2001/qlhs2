				...
				<block id="left" width="1000px">
					<frm.form id="loginForm" title="Đăng nhập" action="<?php echo BASE_REQUEST . '/demo/loginPost'; ?>">
						<frm.formItem type="user-defined" name="label" label="">
							<h2>Đăng nhập</h2>
							<a href="<?php echo BASE_REQUEST . '/demo/login'; ?>" class="demo_login">Dành cho quản trị</a> |
							<a href="<?php echo BASE_REQUEST . '/student/login'; ?>" class="student_login">Dành cho phụ huynh</a> |
							<a href="<?php echo BASE_REQUEST . '/teacher/login'; ?>" class="teacher_login">Dành cho giáo viên</a>
							<script>
								<?php 
								$request = pzk_request();
								...
								?>
								setTimeout(function() {
									jQuery('.<?php echo @$controller;?>_<?php echo @$action;?>').css('font-weight', 'bold');
								}, 200);
							</script>
						</frm.formItem>
