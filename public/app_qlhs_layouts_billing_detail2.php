...
$order = $data->getOrder();
?>
<form method="post" action="<?php echo BASE_REQUEST . '/order/createbillpost2'; ?>">
<div class="order_wrapper">
	<div class="order_header">
		...
		<div class="order_date">
			<div class="order_line">
				...
				<span class="order_line_value">Ngày <input class="easyui-datebox" type="text" name="created" value="<?php echo date('d/m/Y', strtotime($order['created'])); ?>"/></span>
			</div>
		</div>
		<div class="order_no">
		Quyển số: <input style="width: 110px;" type="text" name="bookNum"  value="<?php echo @$order['bookNum'];?>" /><br />
		Số: <input   type="text" name="noNum"  value="<?php echo @$order['noNum'];?>"/><br />
		Nợ: <input   type="text" name="debit" value="<?php echo @$order['debit'];?>" /><br />
		Có: <input   type="text" name="balance" value="<?php echo @$order['balance'];?>" />
		</div>
	...
	<div class="order_body">
		<div class="order_line">
			...
			<span class="order_line_value"><input type="text" name="order_name" value="<?php echo @$order['name'];?>"  style="width: 300px" /></span>
		</div>
		<div class="order_line">
			<span class="order_line_label">Địa chỉ: </span>
			<span class="order_line_value"><input type="text" name="address"  value="<?php echo @$order['address'];?>"  style="width: 300px"/></span>
		</div>
		<div class="order_line">
			<span class="order_line_label">Số điện thoại: </span>
			<span class="order_line_value"><input type="text" name="phone"  value="<?php echo @$order['phone'];?>"  style="width: 300px"/></span>
		</div>
		<div class="order_line">
			<span class="order_line_label">Lý do chi: </span>
			<span class="order_line_value"><input type="text" name="reason"  style="width: 300px"  value="<?php echo @$order['reason'];?>" /></span>
		</div>
		<div class="order_line">
			<span class="order_line_label">Số tiền: </span>
			<span class="order_line_value"><input type="text" name="total_amount" class="input_total_amount"  value="<?php echo product_price($order['amount'])?>" /></span>
		...
		<div class="order_line">
			...
			<span class="order_line_value"><input type="text" name="additional"  value="<?php echo @$order['additional'];?>" /></span>
			<span class="order_line_label">Chứng từ gốc: </span>
			<span class="order_line_value"><input type="text" name="invoiceNum"  value="<?php echo @$order['invoiceNum'];?>"  /></span>
