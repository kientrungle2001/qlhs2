...
<dg.dataGrid id="dg" title="Danh sách hóa đơn" scriptable="true" table="general_order" width="800px" height="450px">
	...
	<layout.toolbar id="dg_toolbar">
		<hform id="dg_search" onsubmit="searchOrder(); return false;">
			...
			<layout.toolbarItem action="if(window.viewMode == true) $dg.detail({url: '<?php echo BASE_REQUEST . '/order/detail'; ?>', 'gridField': 'id', 'action': 'view', 'renderRegion': '#order-detail'});" icon="sum" />
