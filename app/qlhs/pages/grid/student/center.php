<div style="margin-top: 10px;">
	...
	<!-- Sidebar -->
<!--
	<div style="float: left; width: 40px; padding: 4px; margin: 4px; border: 1px solid #888; text-align: center;">
		<div>
			<a href="#" onClick="$('#dg_class_selector').dialog('open'); return false;">Lớp</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Kỳ TT</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Kỳ CTT</a>
		</div>
		<div>
			<a href="#" onClick="return false;">PT</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Màu</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Kiểu</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Tiềm năng</a>
		</div>
		<div>
			<a href="#" onClick="return false;">Hạng</a>
		</div>
		<div>
			<a href="#" onClick="return false;">TT</a>
		</div>
	</div>
	-->
	<!-- Hết sidebar -->
